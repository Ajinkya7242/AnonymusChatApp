...
import com.example.messagingapp.BR;
import com.example.messagingapp.R;
import com.example.messagingapp.databinding.RowChatBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.row_chat,parent,
                false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.binding.setVariable(BR.chatMessage,chatMessageList.get(position));
